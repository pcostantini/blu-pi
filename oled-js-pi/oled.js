...
var Oled = function(opts) {
  ...
  this.ADDRESS = opts.address || 0x3D;
  this.PROTOCOL = 'I2C';
  this.DEVICE = opts.device || "/dev/i2c-0";
  ...
  // Setup i2c
  this.wire = new i2c(this.ADDRESS, {device: this.DEVICE}); // point to your i2c address, debug provides REPL interface
